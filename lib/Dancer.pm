...
This hook receives two arguments. The first one is a HASHREF containing the tokens. The second is a string representing the content of the template.

  hook before_layout_render sub {
    my ($tokens, $html_string) = @_;
    ...
  };
...
This hook receives as argument a string representing the content generated by the template.
...
This hook receives as argument a string representing the content generated by the layout
