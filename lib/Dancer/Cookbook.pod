...
=head2 Using the prefix feature to split you application

For a better maintability, you may want to separate some of your application
...
application, all you have to do is to set C<plack_middlewares> like that:
    ...
    set plack_middlewares => {
        'Debug' => [ 'pannels' => [ qw(DBITrace Memory Timer) ]],
    };
