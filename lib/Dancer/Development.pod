...
your clone (C<master> is used only for building releases).
	...
	$ git remote add sukria https://github.com/sukria/Dancer.git
    $ git checkout -b devel sukria/devel
...
less commits than sukria's repo, you'll be imediatly notified by git.
...
Apply your patch to your clone and then commit and push to your repository
	...
	[ commit as much as possible, with small and related commits ]
    $ git push origin devel

If your patch fixes an existing issue on our bugtracker, please specify
the id of the issue in your commit message.

    fix GH #123: some explanation of the fix

If your patch fixes a RT issue, do the same:

    fix RT #123: some explanation of the fix
