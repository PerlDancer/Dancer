...
BEGIN {
    ...
    plan tests => 7;
    use_ok 'Dancer::Template::TemplateToolkitClassic';
};
...
my $engine;
eval { $engine = Dancer::Template::TemplateToolkitClassic->new };
like $@, qr/Template is needed by Dancer::Template::TemplateToolkitClassic/,
...
# as a file path
my $template = path('t', '10_template', 'index_tt.txt');
