...
my $script = Dancer::Script->init(appname => 'Hello::World', path => '.', check_version => '1');
isa_ok( $script, 'Dancer::Script', );
can_ok( $script, '_parse_opts', '_validate_app_name', );
