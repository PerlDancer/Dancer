...
my @module_files = (
    ...
    'Dancer/HTTP.pm',
    'Dancer/HTTP/Body.pm',
    'Dancer/HTTP/Body/MultiPart.pm',
    'Dancer/HTTP/Body/OctetStream.pm',
    'Dancer/HTTP/Body/UrlEncoded.pm',
    'Dancer/HTTP/Body/XForms.pm',
    'Dancer/HTTP/Body/XFormsMultipart.pm',
    'Dancer/Handler.pm',
